...
```{r figure2, echo=FALSE, message=FALSE, fig.height=5, fig.width=5, fig.align='center', fig.cap='Example map from the Geography of Genetic Variants web application. Each pie chart represents a population with the blue slice of the pie displaying the freqeuncy of the global minor allele and the yellow slice of the pie displaying the frequency of the global major allele in each population.'}
...
```{r figure3, echo=FALSE, message=FALSE, fig.height=6, fig.width=6, fig.align='center', fig.cap='Figure caption'}
...
```{r figure4, echo=FALSE, message=FALSE, fig.height=6, fig.width=6, fig.align='center', fig.cap='Figure caption'}
...
```{r figure5, echo=FALSE, message=FALSE, fig.height=6, fig.width=6, fig.align='center', fig.cap='Figure caption'}
...
## Query API by chromosome position {-}
