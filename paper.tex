...
\begin{figure}[h]
 \centering
 \includegraphics[width=.5\textwidth]{figures/pdf/figure3.pdf}
...
\begin{center}
  \begin{table}[h]
    \begin{tabular}
        ...
        0.025 &  0.1 & \parbox[c]{1em}{\includegraphics[width=.3in]{./figures/pdf/pie_red.pdf}} \\
        0.0025 &  0.01 & \parbox[c]{1em}{\includegraphics[width=.3in]{./figures/pdf/pie_green.pdf}} \\
        0.00025 &  0.001 & \parbox[c]{1em}{\includegraphics[width=.3in]{./figures/pdf/pie_green.pdf}}
    \end{tabular}
